...
void free_gfield_f_fund(suNg_field *u);/*JW*/
suNg_field* alloc_gfield_f_fund(geometry_descriptor* type);/*JW*/
...
void free_spinor_field_f_fund(spinor_field_fund *s);/*JW*/
spinor_field_fund* alloc_spinor_field_f_fund(unsigned int n, geometry_descriptor *type);/*JW*/
